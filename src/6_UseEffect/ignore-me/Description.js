  ...
  return (
    <div>
      ...
      >
        ...
        <span>
          Write a functional React component called <code>Timer</code> in{" "}
        ...
        <span>
          Make sure to clean up any timers or listeners when the component is
          unmounted.
        </span>
      </TaskChecklist>
    </div>
